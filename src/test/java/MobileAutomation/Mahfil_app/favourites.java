...
public class favourites extends configAppium {
	...
	@Test(priority = 1, description = "Favourite Testcase 01: Check Guest user cannot access favourite", groups = {
			"guest" })
	...
	@Test(priority = 2, description = "Favourite Testcase 02: Check favourite button is working", groups = { "general",
			"premium" })
	...
	@Test(priority = 3, description = "Favourite Testcase 03: Check notification button is working in favourite page", groups = {
			"general", "premium" })
	...
	@Test(priority = 4, description = "Favourite Testcase 04: Check search button is working in favourite page", groups = {
			"general", "premium" })
	...
	@Test(priority = 5, description = "Favourite Testcase 05: Check back button is working from favourite page", groups = {
			"general", "premium" })
...
//	}
	...
	@Test(priority = 8, description = "Favourite Testcase 08: Check video added to favourites are playable ", groups = {
			"general", "premium" })
