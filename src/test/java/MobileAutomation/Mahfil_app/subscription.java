...
//		}
	...
	@Test(priority=5, description="Subscription Testcase 03: Check buy premium button is showing in Subscription page",groups= {"general"})
...
//		driver.findElement(By.xpath("(//android.widget.Button)[1]")).click();
	...
	@Test(priority=5, description="Subscription Testcase 03: Check buy premium button is showing in Subscription page",groups= {"general"})
	public void premiumBuyURLCheck() {
		driver.findElement(By.xpath("(//android.widget.ImageView)[1]")).click();
		driver.findElement(AppiumBy.accessibilityId("Subscription")).click();
		driver.findElement(By.xpath("(//android.widget.Button)[1]")).click();
		String actualURL=driver.getCurrentUrl();
		System.out.println(actualURL);
//		String expectedURL="https://subscription.mahfil.net/";
//		Assert.assertEquals(actualURL,expectedURL,"Title didn't matched");
	}
}
