...
public class subscribedChannelLocators {
	AndroidDriver driver;
	public subscribedChannelLocators(AndroidDriver driver) {
//		super(driver);
		this.driver=driver;
	...
	private WebElement subscribedChannelPageTitle;
	
	//Empty Download page  locators
	@AndroidFindBy(accessibility="Subscribed channel will appear here!")
	private WebElement emptysubscribedChannelPageTitle;
	...
	public void checkTitle(String page, String title) {
		String actualTitle="";
		if(page.equals("subscribedChannelPageTitle"))
		{
			actualTitle=subscribedChannelPageTitle.getAttribute("contentDescription");
		}
		else if(page.equals("emptysubscribedChannelPageTitle"))
		{
			actualTitle=emptysubscribedChannelPageTitle.getAttribute("contentDescription");
		}
