...
public class subscriptionLocator {
	...
	public subscriptionLocator(AndroidDriver driver) {
//		super(driver);
		this.driver=driver;
		PageFactory.initElements(new AppiumFieldDecorator(driver), this);
	}
	//Subscription page title locators
	@AndroidFindBy(xpath="(//android.view.View)[6]")
	private WebElement subscriptionPageTitle;
	...
	//Buy premium button locators
	@AndroidFindBy(xpath="(//android.widget.Button)[1]")
	private WebElement buyPremiumButton;
	//Package info locators
	...
	public void buyPremium() {
		buyPremiumButton.click();
	}
	
	public void checkTitle(String page, String title) {
		String actualTitle="";
		if(page.equals("subscriptionPageTitle"))
		{
			actualTitle=subscriptionPageTitle.getAttribute("contentDescription");
		}
		...
		else if(page.equals("buyPremiumButton"))
		{
			actualTitle=buyPremiumButton.getAttribute("contentDescription");
		}
		else if(page.equals("packageInfo"))
		{
			actualTitle=packageInfo.getAttribute("contentDescription");
		}
